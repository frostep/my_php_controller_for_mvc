			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?php echo PATH; ?>/assets/img/products/iphone_1.jpg" alt=""></a>
							</div>
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?php echo PATH; ?>/assets/img/products/canon_eos_5d_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?php echo PATH; ?>/assets/img/products/hp_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?php echo PATH; ?>/assets/img/products/apple_cinema_30.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?php echo PATH; ?>/assets/img/products/imac_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
